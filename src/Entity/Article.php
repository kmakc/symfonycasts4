...
class Article
{
     ...
     * @Assert\NotBlank(message="Title is required field!")
     */
    private $title;
    ...
    {
        if (stripos($this->getTitle(), 'hahaha')) {
            $context->buildViolation('there is some hahaha error')
                ->atPath('title')
                ->addViolation();
        }
    }
    ...
    public function setLocation(?string $location): self
    {
        ...
        if (!$location || $location === 'interstellar_space') { // interstellar_space to article constant
